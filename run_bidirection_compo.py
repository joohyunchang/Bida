...
def get_args():
    ...
    parser.add_argument('--data_set', default='Kinetics-400', choices=['ActivityNet','HD_EPIC','HD-EPIC-sounds','EPIC_dense','diving-48','Kinetics-400', 'SSV2','MINI_SSV2', 'UCF101', 'HMDB51','image_folder', 'EPIC','Kinetics_sound', 'EPIC_sounds','VGGSound'],
